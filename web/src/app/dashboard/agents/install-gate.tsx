/**
 * Server-only install gate + Connect-the-Queen CTA.
 *
 * Extracted from the former dashboard root page so the Agents page can run the
 * same gate: a signed-in user whose session has no GitHub App installation sees
 * the Connect CTA instead of an empty/erroring agents list.
 */
...
export async function sessionHasInstallation(): Promise<boolean> {
...
export function ConnectRepoCta() {
  return (
